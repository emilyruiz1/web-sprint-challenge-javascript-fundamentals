...
//nested fuction can access the variable internal because it can access global variables and outer functions. 
...
function summation(number) {
  ...
  console.log('Task 2:', summation(20));
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(){
    ...
    zooAnimals.forEach(animal => nameScientific.push(`name: ${animal.animal_name}, scientific: ${animal.scientific_name}`)); 
...
console.log('Request 1:', animalNames());
  ...
  */
  ...
  function USApop(zooAnimals){
    const USApop = zooAnimals.reduce(function(previousValue, currentValue) {
      return previousValue + currentValue.population
    }, 0)
    return USApop;
  }
  
  console.log('Resquest 4:', USApop(zooAnimals));
...
console.log(greeting('Emily', 'Ruiz'));
